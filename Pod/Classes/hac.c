...
//
//
// some code borrowed from Gagarine Yaikhom (MIT License)
...
cluster_t * clusterItems(item_t * items, int numItems){
    cluster_t *cluster = agglomerate(numItems, items);
    return cluster;
}
